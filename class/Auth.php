...
class Auth {
    ...
    { 
        ...
        try {
            $stmt = $pdo->prepare("SELECT password,id FROM user WHERE username = :username");
            ...
            else 
            {
                ...
                {
                    $errorMessages['Error'] = "Password hoặc Username không đúng nhá";
                }
