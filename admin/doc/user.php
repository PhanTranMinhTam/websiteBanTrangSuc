...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Xóa người dùng
    $success = User::deleteUser($pdo, $id);
                    ...
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                              ...
                              <a class="btn btn-add btn-sm" href="ThemNguoiDung.php" title="Thêm"><i class="fas fa-plus"></i>
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        <?php foreach($data as $user): ?>
            <tr>
                <td><?= $user['id'] ?></td>
                <td><a href="detail_product.php?id=<?= $user['id'] ?>"><?php echo $user['username'] ?></a></td>
                <td><?= $user['email'] ?></td>
                <td><?= $user['gender'] ?></td>
                <td><?= $user['password'] ?></td>
                <td>
                    <div class="btn-group" role="group">
                        <a href="../doc/SuaNguoiDung.php?id=<?= $user['id'] ?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                <?php endfor; ?>
                <li class="page-item">
                    <a class="page-link" href="user.php?page=<?= min($page + 1, $totalPages) ?>" aria-label="Next">
