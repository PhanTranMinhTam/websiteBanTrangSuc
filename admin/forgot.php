...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $email_sent = new Emailer();
    $to = $email;
    $titles = "Doi mat khau";
    $content = "Mat khau moi : Tamminh180203$";
    $email_sent ->sentEmail($to,$titles,$content);
}
        ...
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <div class="text-center p-t-12">
                    <a class="txt2" href="../admin/index1.php">
                        Trở về đăng nhập
                    </a>
                </div>
            </form>
            <div class="text-center p-t-70 txt2">
                Phần mềm quản lý bán hàng trang sức  <i class="far fa-copyright" aria-hidden="true"></i>
                <script type="text/javascript">document.write(new Date().getFullYear());</script> <a class="txt2" href="#"> Code bởi Phan Trần Minh Tâm </a>
            </div>
        </div>
    </div>
</div>
