...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../doc/css/style_logo.css">
        <link rel="stylesheet" href="../doc/css/style_product.css">
        <link rel="stylesheet" href="../doc/css/style_register.css">
...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../images/hello.png" width="50px"
        alt="User Image">
      <div>
        <p class="app-sidebar__user-name"><b>Minh Tâm</b></p>
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="user.php"><i class='app-menu__icon bx bx-id-card'></i>
          <span class="app-menu__label">Quản lý người dùng</span></a></li>
      <li><a class="app-menu__item " href="category.php"><i class='app-menu__icon bx bx-user-voice'></i><span
