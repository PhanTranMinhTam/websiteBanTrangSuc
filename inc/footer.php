                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="footer_widget">
                                    <h3>LIÊN HỆ</h3><br>
                                    <img src="assets\img\logo\logoMTam.png" width="170px" height="170px" alt="">
                                    <p>Tập đoàn Minh Tâm Jewelry.</p>
                                    <div class="footer_widget_contect">
                                        <p><i class="fa fa-map-marker" aria-hidden="true"></i>Địa chỉ: Tòa nhà DOJI Tower, Số 5 Lê Duẩn, Ba Đình, Hà Nội</p>

                                        <p><i class="fa fa-mobile" aria-hidden="true"></i> Điện thoại:1800 1168</p>
                                        <a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> Email:phantranminhtam2873@gmail.com</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="footer_widget">
                                    <h3>VỀ CHÚNG TÔI</h3>
                                    <ul>
                                        <li><a href="#">Về trang sức Minh Tâm</a></li>
                                        <li><a href="#">Dịch vụ khách hàng</a></li>
                                        <li><a href="#">Kinh doanh bán sỉ</a></li>
                                        <li><a href="#">Minh Tâm ELITE CLUB</a></li>
                ...
                <div class="footer_bottom">
                    <div class="container">
                        ...
                        <div class="copyright_area">
                            ...
                            <img src="assets\img\logo\logo_dangky.png" width="200px" height="70px" alt="">
                            <p>Copyright &copy; 2024 <a href="#">Minh Tâm</a>. All rights reserved. </p>
                        </div>
                    </div>
                            <div class="col-lg-6 col-md-6">
